...
def getCanvas(title):
	...
	legend = ROOT.TLegend(0.8040201,0.7167832,0.9974874,0.8566434,"","brNDC")
...
if __name__ == '__main__':
  ...
  for m in masses:
    ...
    cutTAGHP ="(jj_l1_mergedVTruth==1&&njj>0&&abs(jj_l1_eta-jj_l2_eta)<1.3&&jj_l1_softDrop_mass>55.&&jj_l1_softDrop_mass<215.&&(jj_l1_tau2/jj_l1_tau1+(0.080*TMath::Log((jj_l1_softDrop_mass*jj_l1_softDrop_mass)/jj_l1_pt)))<=0.43)&&jj_l1_softDrop_mass>55.&&jj_l1_softDrop_mass<215."
    cutTAGLP ="(jj_l1_mergedVTruth==1&&njj>0&&abs(jj_l1_eta-jj_l2_eta)<1.3&&jj_l1_softDrop_mass>55.&&jj_l1_softDrop_mass<215.&&(jj_l1_tau2/jj_l1_tau1+(0.080*TMath::Log((jj_l1_softDrop_mass*jj_l1_softDrop_mass)/jj_l1_pt)))>0.43&&(jj_l1_tau2/jj_l1_tau1+(0.080*TMath::Log((jj_l1_softDrop_mass*jj_l1_softDrop_mass)/jj_l1_pt)))<0.79)&&jj_l1_softDrop_mass>55.&&jj_l1_softDrop_mass<215."
    ...
    # if m == 600.:
    #   uncertianties_HP.append(0.043)
    #   uncertianties_LP.append(0.043)
 ...
 #  uncertianties_LP.append(uncertianties_LP[-1])
  uncertianties_HP[0]=0.043
  uncertianties_LP[0]=0.043
  vx = array("f",masses)
  ...
  log = False
  if log:
    f_HP = rt.TF1("ptdep_HP", "[0]*log(x/600)", 500, 5000)
    f_LP = rt.TF1("ptdep_LP", "[0]*log(x/600)", 500, 5000)
    f_HP.SetParameter(0,-5.66460e-02)
    f_LP.SetParameter(0,-5.66460e-02)
  else:  
    f_HP = rt.TF1("ptdep_HP", "[0]/(1+TMath::Exp(-[1]*(x-[2])))", 500, 5000)
    f_LP = rt.TF1("ptdep_LP", "[0]/(1+TMath::Exp(-[1]*(x-[2])))", 500, 5000)
    f_HP.SetParameters(3.08405e-01, 1.20164e-02, 3.08405e-01)
    f_LP.SetParameters(2.01524e-01, 2.46550e-03, 1.08966e+03)
